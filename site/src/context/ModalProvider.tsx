...
const Modal: React.FC<ModalConfig> = ({ type = 'default', title, message, button1 = 'OK', button2 = undefined, button3 = undefined, onButton1Submit, onButton2Submit, onButton3Submit, activeButton, messageAsInput = false, maxInputLength = 32 }) => {
