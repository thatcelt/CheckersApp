...
export async function changeSettings(possibleMoves: boolean, vibration: boolean) {
    const response = await fetch(`https://${API_URL}/api/v1/user/changeSettings?possibleMoves=${possibleMoves}&vibration=${vibration}`, {
        method: 'PATCH', 
        headers: {
            'Content-Type': 'application/json',
            'Authorization': token
...
export async function getFriends() {
    const response = await fetch(`https://${API_URL}/api/v1/user/getFriends`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': token
...
export async function addFriend(userId: string) {
    const response = await fetch(`https://${API_URL}/api/v1/user/addFriend/${userId}`, {
        method: 'POST',
        headers: {
            'Authorization': token
        }
...
export async function removeFriend(userId: string) {
    const response = await fetch(`https://${API_URL}/api/v1/user/removeFriend/${userId}`, {
        method: 'POST',
        headers: {
            'Authorization': token
        }
